...
from settings.settings import ANALYSIS_AND_ADVICE,CORP_ACTION_GOVERNANCE,YOUR_API_KEY,CORPORATE_FINANCE,HEALTH_CLINICAL,EQUITY_MARKET_NEWS,EVENTS,GENERAL,SPECIFIC_MARKETS,PRODUCT_PARTNERSHIP,REGULATORY
CATEGORY_KEYWORDS = {
...
CATEGORY_WEBHOOKS = {
    "EQUITY_MARKET_NEWS": EQUITY_MARKET_NEWS,
    "ANALYSIS_AND_ADVICE": ANALYSIS_AND_ADVICE,
    "SPECIFIC_MARKETS": SPECIFIC_MARKETS,
    "CORP_ACTION_GOVERNANCE": CORP_ACTION_GOVERNANCE,
    "CORPORATE_FINANCE": CORPORATE_FINANCE, # Make sure this entry exists
    "HEALTH_CLINICAL": HEALTH_CLINICAL,
