...
function displayCodeSnippet() {
    ...
    if (selectedSnippet === "") {
        ...
        let snippet = "";
        if (window.snippets && window.snippets.BotTutorial && window.snippets.BotTutorial.hasOwnProperty(selectedSnippet)) 
            snippet = window.snippets.BotTutorial[selectedSnippet];
