...
class FUDSTOPMenu(disnake.ui.Select):
    ...
    async def callback(self, interaction:disnake.MessageCommandInteraction):
        ...
        if self.values[0] == "map🗾Heatmaps":
            ...
            em.add_field(name="ut💡darkpools",value="<#1041135848848097420>")
            em.add_field(name="ut💡unusual options",value="<#1041138585568546867>")
            em.add_field(name="ut💡golden sweeps",value="<#1041138564097900576>")
            em.add_field(name="ut💡quant alerts",value="<#1041138585560154192>")
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="etf⚓darkpools",value="<#1041136262247092294>")
            em.add_field(name="etf⚓unusual options",value="<#1041135315945009182>")
            em.add_field(name="etf⚓quant alerts",value="<#1041136306027253790>")
            em.add_field(name="etf⚓golden sweeps",value="<#1041136395097473134>")
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="cc🌒darkpools",value="<#1041139072149758053>")
            em.add_field(name="cc🌒unusual options",value="<#1041138764774395914>")
            em.add_field(name="cc🌒golden sweeps",value="<#1041138739616944289>")
            em.add_field(name="cc🌒quant alerts",value="<#1041138764006821958>")
            em.add_field(name="Navigation Code:",value="```py\ncc```")
            await interaction.edit_original_message(f"</navigate channels:1034275861865705476>",embed=em)
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="fd📶darkpools - consolidated",value="<#1014186460162822234>")
            em.add_field(name="fd📶goldensweeps - consolidated",value="<#1009157079803637851>")
            em.add_field(name="fd📶quant alerts - consolidated",value="<#1013870207456006164>")
            em.add_field(name="fd📶REG SHO - consolidated",value="<#1014186417385115728>")
            em.add_field(name="fd📶Trading Halts - consolidated",value="<#961095958295347200>")
            em.add_field(name="fd📶Unusual Options - consolidated",value="<#1009157366769524747>")
            em.add_field(name="fd📶Large Dark Pools - consolidated",value="<#1035211665991553074>")
            em.add_field(name="Navigation Code:",value="```py\nfd```")
            await interaction.edit_original_message(f"</navigate channels:1034275861865705476>",embed=em)
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)
            ...
            await interaction.edit_original_message(embed=em)
            await interaction.send("```py\nClick this command and type 'nw' to see the list. There are more channels than listed here.``` </navigate channels:1034275861865705476>", ephemeral=False)  
        
        elif self.values[0] =="cs📣Communication Services Sector":
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="cs📣darkpool",value="<#1041136662845079692>")
            em.add_field(name="cs📣unusual options",value="<#1041136568263512186>")
            em.add_field(name="cs📣quant alerts",value="<#1041136505432842401>")
            em.add_field(name="cs📣golden sweeps",value="<#1041135392298123364>")
            em.add_field(name="Navigation Code:",value="```py\ncs```")
            await interaction.edit_original_message(embed=em)
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="re🏠darkpool",value="<#1041135715561508894>")
            em.add_field(name="re🏠unusual options",value="<#1041138037628866570>")
            em.add_field(name="re🏠quant alerts",value="<#1041138018997768282>")
            em.add_field(name="re🏠golden sweeps",value="<#1041137999372619827>")
            em.add_field(name="Navigation Code:",value="```py\nre```")
            await interaction.edit_original_message(embed=em)
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="he💉darkpool",value="<#1041135759350042714>")
            em.add_field(name="he💉unusual options",value="<#1041138212250329110>")
            em.add_field(name="he💉golden sweeps",value="<#1041138189080989717>")
            em.add_field(name="he💉quant alerts",value="<#1041138211927359528>")
            em.add_field(name="Navigation Code:",value="```py\nhe```")
            await interaction.edit_original_message(embed=em)
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
        elif self.values[0] =="te💿Technology Sector":
            emte = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            emte.add_field(name="te💿darkpool",value="<#1041135662956544051>")
            emte.add_field(name="te💿unusual options",value="<#1041137838936301568>")
            emte.add_field(name="te💿quant alerts",value="<#1041137858225905695>")
            emte.add_field(name="te💿goldensweeps",value="<#1041137816358371348>")
            em.add_field(name="Navigation Code:",value="```py\nte```")
            ...
            emin.add_field(name="in🌆darkpools",value="<#1041135608585785374>")
            emin.add_field(name="in🌆unusual options",value="<#1041137576788103238>")
            emin.add_field(name="in🌆golden sweeps",value="<#1041135609835700264>")
            emin.add_field(name="in🌆quant alerts",value="<#1041137553153204246>")
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="cd⛴️darkpools",value="<#1041135509302427678>")
            em.add_field(name="cd⛴️unusual options",value="<#1041137069474463754>")
            em.add_field(name="cd⛴️golden sweeps",value="<#1041137112700948480>")
            em.add_field(name="cd⛴️quant alerts",value="<#1041137132854595584>")
            em.add_field(name="Navigation Code:",value="```py\ncd```")  
            await interaction.edit_original_message(embed=em)
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="fs💰darkpools",value="<#1041135561051754586>")
            em.add_field(name="fs💰unusual options",value="<#1041137298479255584>")
            em.add_field(name="fs💰golden sweeps",value="<#1041137255022075946>")
            em.add_field(name="fs💰quant alerts",value="<#1041137276538847363>")
            em.add_field(name="Navigation Code:",value="```py\nfs```")
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
            await interaction.edit_original_message(embed=em)
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="bm🧱darkpools",value="<#1041135461634154577>")
            em.add_field(name="bm🧱unusual options",value="<#1041136912167096420>")
            em.add_field(name="bm🧱golden sweeps",value="<#1041136767249694811>")
            em.add_field(name="bm🧱quant alerts",value="<#1041136768696729610>")
            em.add_field(name="Navigation Code:",value="```py\nbm```")
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
            await interaction.edit_original_message(embed=em)
            ...
            em = disnake.Embed(title="Sector Monitoring", description=f"```py\nSector monitoring for stock market industries. Each section contains dark pool feeds, quant alerts, unusual options alerts, regulation SHO alerts, and dark pool feeds real-time.```",color=disnake.Colour.random())
            em.add_field(name="en⚡darkpools",value="<#1041135801813180436>")
            em.add_field(name="en⚡unusual options",value="<#1041138407625216080>")
            em.add_field(name="en⚡golden sweeps",value="<#1041138385940660305>")
            em.add_field(name="en⚡quant alerts",value="<#1041138407184801812>")
            em.add_field(name="Navigation Code:",value="```py\nen```")
            await interaction.send("</navigate channels:1034275861865705476>", ephemeral=False)  
            await interaction.edit_original_message(embed=em)
...
class FlowSelect(disnake.ui.Select):
    def __init__(self):
        super().__init__(
            placeholder="🇫 🇱 🇴 🇼 💦 🇨 🇴 🇲 🇲 🇦 🇳 🇩 🇸",
            min_values=1,
            max_values=1,
            custom_id="flowselect",
            options = [
                disnake.SelectOption(label="💦 Flow",value=1, description="Searches Quant Data's flow database and returns the results."),
                disnake.SelectOption(label="💦 Day",value=2, description="Returns the most recent flow for a stock."),
                disnake.SelectOption(label="💦 Bigflow",value=3, description="Returns the top 20 flow tickers by premium."),
                disnake.SelectOption(label="💦 Opening",value=4, description="Top 20 flow tickers with opening condition met."),
                disnake.SelectOption(label="💦 Sumday",value=5, description="Returns flow summary by expiration date for a ticker."),
                disnake.SelectOption(label="💦 Sumweek",value=6, description="Graph total premium weekly summary for a stock."),
                disnake.SelectOption(label="💦 Sumexp",value=7, description="Searches Quant Data's flow database and returns the results."),
                disnake.SelectOption(label="💦 Prem",value=8, description="Returns a chart with sum of premium per day by calls/puts."),
                disnake.SelectOption(label="💦 Unu",value=9, description="Returns unusual options trade with over 100k Premium."),
                disnake.SelectOption(label="💦 Weekly",value=10, description="Top 20 flow by premium for weekly expiring stocks."),
                disnake.SelectOption(label="💦 Sectors",value=11, description="Summary by % market cap by Sector."),
                disnake.SelectOption(label="💦 Sumtop",value=12, description="Top flow for the day for a stock calls vs puts."),
                disnake.SelectOption(label="💦 Summary",value=13, description="Summary of all flow by % market cap."),])

    async def callback(self, interaction: disnake.MessageCommandInteraction):
        if self.values[0] == 1:
            await interaction.send(f"</flow:910724015490998293>",ephemeral=False)
            
        elif self.values[0] == 2:  
            await interaction.send(f"</flow day:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 3:
            await interaction.send(f"</flow bigflow:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 4:
            await interaction.send(f"</flow sumexp:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 5:
            await interaction.send(f"</flow opening:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 6:
            await interaction.send(f"</flow sumday:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 7:
            await interaction.send(f"</flow sumweek:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 8:
            await interaction.send(f"</flow prem:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 9:
            await interaction.send(f"</flow unu:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 10:
            await interaction.send(f"</flow weekly:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 11:
            await interaction.send(f"</flow sectors:1004263746170011749>",ephemeral=False)
        elif self.values[0] == 12:
            await interaction.send(f"</flow sumtop:1004263746170011749>",ephemeral=False)
